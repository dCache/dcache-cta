...
| cta-use-tls              | A switch (none/tls/mtls or true/false) to enable TLS for CTA control connection |       no | `none`     |
| cta-tls-cert             | The path to TLS certificate for use with mTLS                                   |       no | -          |
| cta-tls-key              | The path to TLS key for use with mTLS                                           |       no | -          |
| cta-frontend-timeout     | How long dCache waits in seconds for CTA frontend to reply                      |       no | 30         |
